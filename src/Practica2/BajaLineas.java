...
public class BajaLineas extends Frame implements WindowListener, ActionListener
{
	private static final long serialVersionUID = 1L;
	Label lblEdificioFactura = new Label("Linea a borrar:");
	...
	BajaLineas()
	{
		...
		try {
			...
			while (rs.next()) 
			{
				choLineas.add(rs.getInt("idLinea")+
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(objetoPulsado.equals(btnSi))
		{
			...
			choLineas.removeAll();
			choLineas.add("Seleccione la linea");
			String sqlSelect = "SELECT * FROM lineas";
			try {
				// CREAR UN STATEMENT PARA UNA CONSULTA SELECT
				Statement stmt = con.createStatement();
