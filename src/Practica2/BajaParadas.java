...
public class BajaParadas extends Frame implements WindowListener, ActionListener
{
	...
	BajaParadas()
	{
		...
		try {
			...
			while (rs.next()) 
			{
				choLineas.add(rs.getInt("idParada")+
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(objetoPulsado.equals(btnSi))
		{
			...
			if(respuesta == 0)
			{
				System.out.println("Borrado de linea correcto");
			}
			else
			{
				System.out.println("Error en Borrado de linea");
			}
